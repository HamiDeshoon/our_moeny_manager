      ...
      <DashboardCarousel
        slides={[
          <section className="space-y-4" key="balances">
            <div className="rounded-[1.5rem] border border-teal-300/15 bg-[#14231e] p-4 shadow-xl shadow-black/20">
          ...
          <section className="rounded-[1.5rem] border border-white/10 bg-[#14231e] p-4 shadow-xl shadow-black/20" key="budget">
          ...
          <section className="rounded-[1.5rem] border border-amber-300/10 bg-[#14231e] p-4 shadow-xl shadow-black/20" key="insights">
