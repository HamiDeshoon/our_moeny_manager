      ...
      <DashboardCarousel
        slides={[
          <section className="space-y-4" key="balances">
            <div className="premium-card border-black/10 bg-[#fffdf8] p-4 shadow-xl shadow-black/10">
            ...
            <button type="button" onClick={onViewTransactions} className="tap-scale flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-[#161c19] px-4 text-sm font-bold text-white hover:bg-[#303a34]">
              دیدن همه تراکنش‌ها <ArrowLeft className="h-4 w-4" />
            </button>
          </section>,
          <section className="premium-card bg-[#fffdf8] p-4 shadow-xl shadow-black/10" key="budget">
