      ...
      <DashboardCarousel
        slides={[
          <section className="space-y-4" key="balances">
            <div className="premium-card border-teal-300/20 bg-[#11241f]/80 p-4">
          ...
          <section className="premium-card bg-[#11241f]/80 p-4" key="budget">
          ...
          <section className="premium-card border-amber-300/20 bg-[#11241f]/80 p-4" key="insights">
